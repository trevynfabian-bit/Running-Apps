...
- Workspace ID: `81a49e99-33e4-465a-9c94-137f94375701`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/81a49e99-33e4-465a-9c94-137f94375701.
...
2. `npx ngodingpakeai connect --workspace 81a49e99-33e4-465a-9c94-137f94375701 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/81a49e99-33e4-465a-9c94-137f94375701. Only pass on links the CLI actually printed — never assemble one from an id yourself.
