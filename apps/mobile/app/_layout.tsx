...
import { CompositionSessionsProvider } from '../src/lib/composition-session-store';
  ...
  return (
    ...
    >
      ...
      <Stack.Protected guard={status === 'signed_in' && hasCompletedOnboarding}>
        ...
        <Stack.Screen name="composition/privacy" options={{ title: 'Where your data lives' }} />
        <Stack.Screen
          name="why"
